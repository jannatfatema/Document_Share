@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=D:\wordpress\wordpress\php"
...
FOR %%x IN ("D:\wordpress\wordpress\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\wordpress\wordpress\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\wordpress\wordpress\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\wordpress\wordpress\php\php.exe"
